...
@RestController
@RequestMapping("/api/moneymanagerweb-kafka")
public class MoneymanagerwebKafkaResource {
    private final Logger log = LoggerFactory.getLogger(MoneymanagerwebKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public MoneymanagerwebKafkaResource(KafkaProperties kafkaProperties) {
