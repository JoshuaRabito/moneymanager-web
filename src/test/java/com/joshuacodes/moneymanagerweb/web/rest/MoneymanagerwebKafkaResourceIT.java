...
import com.joshuacodes.moneymanagerweb.config.KafkaProperties;
...
class MoneymanagerwebKafkaResourceIT {
    ...
    void setup() {
        ...
        MoneymanagerwebKafkaResource kafkaResource = new MoneymanagerwebKafkaResource(kafkaProperties);
    ...
    void producesMessages() throws Exception {
        restMockMvc
            .perform(post("/api/moneymanagerweb-kafka/publish/topic-produce?message=value-produce"))
    ...
    void consumesMessages() throws Exception {
        ...
        MvcResult mvcResult = restMockMvc
            .perform(get("/api/moneymanagerweb-kafka/consume?topic=topic-consume"))
            .andExpect(status().isOk())
